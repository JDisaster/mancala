 ...
 * This JButton represents a single pit or Mancala
 * This class holds the physical properties for both the pits, Mancala, and
 * stones
 */
public class PitButton extends JButton {
     ...
     * 
     * @param index - the specifed index of the pit
     */
    ...
    /**
     * Setter for the colors of the pit button's components
     * 
     ...
     * @param StoneOut - color of stone outlines
     * @param label    - color of labels like A1...
     * @param manA     - color of Mancala of player A
     * @param manB     - color of Mancala of player B
     */
    public void setColor(Color pit, Color stone, Color outlineA, Color outlineB, Color StoneOut, Color label,
            Color manA, Color manB) {
        this.pitColor = pit;
    ...
    /**
     * Checks if pit represents a Mancala pit
     * 
    ...
    /**
     * Setter for the stones in the pit
     * 
    ...
    /**
     * Method alters the paintComponent so now it can draw shapes for the pits and
     * Mancalas as well as the stones
     */
    @Override
    protected void paintComponent(Graphics g) {
        ...
        // Draw the cirles for the stones and have it randomly be placed within the
        // circle
        ...
        if (isMancala()) {
            ...
            while (stonesLeft > 0) {
                ...
                int maxStoneRing = Math.max(1, (int) (circum / (stoneDiameter + spacing))); // Num of stones to fit in a
                                                                                            // ring size
    ...
    /**
     * Getter for pit stone amount
     * 
     * @return - the amount of stones in the pit
     */
